#!/usr/bin/env python3
"""
YOLOv3 model çıxışlarını emal etmək, filtrdən keçirmək və NMS tətbiq etmək.
"""
import numpy as np
...
class Yolo:
    ...
    def non_max_suppression(self, filtered_boxes, box_classes, box_scores):
        ...
        for cls in unique_classes:
            ...
            # Skorlara görə azalan sıra ilə sıralamaq
