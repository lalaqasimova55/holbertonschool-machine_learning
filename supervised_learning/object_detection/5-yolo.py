#!/usr/bin/env python3
"""
YOLOv3 model çıktılarını işlemek, NMS ve görsel ön işleme adımları.
"""
import cv2
import glob
import numpy as np
...
class Yolo:
    ...
    def preprocess_images(self, images):
        """
        Şəkilləri modelin tələb etdiyi ölçülərə gətirir və normalize edir.

        Parametrlər:
            images: numpy.ndarray şəkillərdən ibarət siyahı.
        ...
        for img in images:
            # Orijinal şəkil ölçüsünü almaq (height, width)
            h, w, _ = img.shape
            image_shapes.append((h, w))

            # Şəkil ölçüsünü dəyişmək (inter-cubic interpolation)
            # cv2.resize ölçünü (width, height) olaraq qəbul edir
            ...
            # Piksel dəyərlərini [0, 1] aralığına gətirmək
