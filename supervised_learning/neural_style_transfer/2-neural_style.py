#!/usr/bin/env python3
"""
Neural Style Transfer module with Gram Matrix calculation.
"""
import numpy as np
...
class NST:
    ...
    def gram_matrix(input_layer):
        ...
        # Calculate Gram matrix using einsum over spatial dimensions (h, w)
        # Result shape: (1, c, c)
        gram = tf.linalg.einsum('bijc,bijd->bcd', input_layer, input_layer)

        # Normalize by the spatial dimensions (h * w)
